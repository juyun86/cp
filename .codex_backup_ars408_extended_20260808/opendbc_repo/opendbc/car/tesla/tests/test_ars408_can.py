...
from opendbc.car.tesla.ars408_can import (
  ...
  ARS408_RADAR_CONFIG_ADDRESSES, ARS408_SENSOR_ID, ARS408_SPEED_ADDRESS, ARS408_YAW_RATE_ADDRESS,
  ARS408CAN,
)
...
def test_configuration_uses_250_m_range_and_disables_extended_output():
